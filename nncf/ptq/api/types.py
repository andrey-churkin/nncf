...
# This module contains type aliases that are used in the NNCF.
...
# It means that when the `data_source` object is passed as an argument to the built-it
# function `iter()`, it returns an iterator for the `data_source` object.
...
# This is a type alias for the model to be compressed.
